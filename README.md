...
[![build status](https://img.shields.io/travis/hoangcung1804npm/magni-distinctio-dolore/master.svg?style=flat-square)](https://travis-ci.org/hoangcung1804npm/magni-distinctio-dolore)
[![npm version](https://img.shields.io/npm/v/@hoangcung1804npm/magni-distinctio-dolore.svg?style=flat-square)](https://www.npmjs.com/package/@hoangcung1804npm/magni-distinctio-dolore)
...
```sh
npm install @hoangcung1804npm/magni-distinctio-dolore @stripe/stripe-js
```
...
import {
  ...
  useStripe,
  useElements,
} from '@hoangcung1804npm/magni-distinctio-dolore';
